...
def register():
    ...
    #Labels
    Label(register_screen, text="Please enter your details below to register",
          font = ('Calibri', 12)).grid(row=0,column=1,sticky=N,pady=10)
    Label(register_screen, text="Name",font = ('Calibri', 12)).grid(row=1,sticky=W)
    Label(register_screen, text="Age",font = ('Calibri', 12)).grid(row=2,sticky=W)
    Label(register_screen, text="Gender",font = ('Calibri', 12)).grid(row=3,sticky=W)
    Label(register_screen, text="Password",font = ('Calibri', 12)).grid(row=4,sticky=W)
    notif = Label(register_screen,font = ('Calibri', 12))
    notif.grid(row=6,column=1, sticky=N, pady=10)
    ...
    #Buttons
    Button(register_screen,text="Register", command= finish_register,
           font= ('Calibri', 12)).grid(row=5,column=1,sticky=N,pady=10)
    ...
    for name in all_accounts:
        if name == login_name:
            ...
            if login_password == password:
                ...
                #Labels
                Label(account_dashboard, text="Account Dashboard",font= ('Calibri', 16)).grid(row=0,sticky=N,pady=10)
                ...
                Button(account_dashboard, text="Personal Details",
                       font= ('Calibri', 12),width= 30,command=personal_details).grid(row=2,sticky=N,padx=10)
                Button(account_dashboard, text="Deposit",
                       font= ('Calibri', 12),width= 30,command=deposit).grid(row=3,sticky=N,padx=10)
                Button(account_dashboard, text="Withdraw",
                       font= ('Calibri', 12),width= 30,command=withdraw).grid(row=4,sticky=N,padx=10)
...
def deposit():
    ...
    #Label
    Label(deposit_screen, text="Deposit", font= ('Calibri', 12)).grid(row=0,column=1,sticky=N,pady=10)
...
def withdraw():
    ...
    #Label
    Label(withdraw_screen, text="Withdraw", font= ('Calibri', 12)).grid(row=0,column=1,sticky=N,pady=10)
...
def login():
    ...
    #Labels
    Label(login_screen, text= "Login to your account",font= ('Calibri', 12)).grid(row=0,column=1,sticky=N,pady=10)
    ...
    Button(login_screen, text="Login", command=login_session, width=15,
           font= ('Calibri', 12)).grid(row=3,column=1,sticky=W,pady=5,padx=5)
